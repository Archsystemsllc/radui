			 ...
			 e.preventDefault();		
	          $("#dialog-confirm" ).dialog({
	              ...
	              buttons: {
	                "Yes": function() {
	              		$( this ).dialog("close");	              		
	              		window.location.href= '${pageContext.request.contextPath}/${SS_USER_FOLDER}/jurisdictionlist';          	 	
	                },
	                Cancel: function() {                    
	                	$( this ).dialog("close"); 
	                }
...
<body >
	...
	<div id="dialog-confirm" title="Close MAC Info Confirmation?">
  		<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Do you want to close the Jurisdiction form without saving?</p>
	</div>
	
	<table id="mid">
		<form:form method="POST" modelAttribute="jurisdiction" enctype="multipart/form-data"  class="form-signin" action="${pageContext.request.contextPath}/${SS_USER_FOLDER}/saveOrUpdateJurisdiction" id="jurisdictionId">
			<tr>
					...
					<div id="updates" class="boxed">
						...
						<div class="content">
							...
							<div class="table-users" style="width: 80%">
								<div class="header">								
								<c:if test="${jurisdiction.id == null || jurisdiction.id == 0}">
										<span>Save Jurisdiction</span>
									</c:if>
				                   ...
				                   <form:hidden path="createdBy" />				                  
			                         ...
			                         <div class="row">
			                          ...
			                          <div class="col-sm-6 form-group">
			                                ...
			                                <form:input class="required form-control" type = "text" name = "jurisdictionName" path="jurisdictionName" />
			                            </div>
			                            <div class="col-sm-6 form-group">
