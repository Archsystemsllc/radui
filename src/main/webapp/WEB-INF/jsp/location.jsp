			 ...
			 e.preventDefault();		
	          $("#dialog-confirm" ).dialog({
	              ...
	              buttons: {
	                "Yes": function() {
	              		$( this ).dialog("close");	              		
	              		window.location.href= '${pageContext.request.contextPath}/${SS_USER_FOLDER}/locationlist';          	 	
	                },
	                Cancel: function() {                    
	                	$( this ).dialog("close"); 
	                }
...
<body >
	...
	<div id="dialog-confirm" title="Close MAC Info Confirmation?">
  		<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Do you want to close the Location form without saving?</p>
	</div>
	
	<table id="mid">
		<form:form method="POST" modelAttribute="location" enctype="multipart/form-data"  class="form-signin" action="${pageContext.request.contextPath}/${SS_USER_FOLDER}/saveOrUpdateLocation" id="locationId">
			<tr>
					...
					<div id="updates" class="boxed">
						...
						<div class="content">
							...
							<div class="table-users" style="width: 80%">
								<div class="header">								
								<c:if test="${location.id == null || location.id == 0}">
										<span>Save PCC/Location</span>
									</c:if>
									<c:if test="${location.id > 0}">
										<span>Update PCC/MAC</span>
									</c:if>
								</div>	
				                  ...
				                  <form:hidden path="createdBy" />				                  
			                         ...
			                         <div class="row">
			                          ...
			                          <div class="col-sm-6 form-group">
			                                <label for="name"> PCC/Location Name:</label>
			                                <form:input class="required form-control" type = "text" name = "pccLocationName" path="pccLocationName" />
			                            </div>
			                            <div class="col-sm-6 form-group">
			                        ...
			                        <div class="row">			                              
			                            <div class="col-lg-6 form-group">
			                             ...
			                             <form:textarea class=" form-control" type = "textarea" name = "description" path="description" />	                                
			                         	</div>
			                         	<div class="col-lg-6 form-group">
