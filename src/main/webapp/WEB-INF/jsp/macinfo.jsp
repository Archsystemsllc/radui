			 ...
			 e.preventDefault();		
	          $("#dialog-confirm" ).dialog({
	              ...
	              buttons: {
	                "Yes": function() {
	              		$( this ).dialog("close");	              		
	              		window.location.href= '${pageContext.request.contextPath}/${SS_USER_FOLDER}/macinfolist';          	 	
	                },
	                Cancel: function() {                    
	                	$( this ).dialog("close"); 
	                }
...
<body >
	...
	<div id="dialog-confirm" title="Close MAC Info Confirmation?">
  		<p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>Do you want to close the MAC form without saving?</p>
	</div>
	
	<table id="mid">
		<form:form method="POST" modelAttribute="macinfo" enctype="multipart/form-data"  class="form-signin" action="${pageContext.request.contextPath}/${SS_USER_FOLDER}/saveOrUpdateMacInfo" id="macInfoId">
			<tr>
					...
					<div id="updates" class="boxed">
						...
						<div class="content">
							...
							<div class="table-users" style="width: 80%">
								<div class="header">								
								<c:if test="${macinfo.id == null || macinfo.id == 0}">
										<span>Save MAC</span>
									</c:if>
									<c:if test="${macinfo.id > 0}">
				                  ...
				                  <form:hidden path="createdBy" />				                  
			                         ...
			                         <div class="row">
			                          ...
			                          <div class="col-sm-6 form-group">
			                                <label for="name"> MAC Name:</label>
			                                <form:input class="required form-control" type = "text" name = "macName" path="macName" />
			                            </div>
			                            <div class="col-sm-6 form-group">
			                         ...
			                         <div class="row">			                              
			                            <div class="col-lg-6 form-group">
			                             ...
			                             <form:textarea class="form-control" type = "textarea" name = "macDescription" path="macDescription" />	                                
			                         	</div>
			                         	<div class="col-lg-6 form-group">
			                        ...
			                        <div class="row">
			                         	...
			                         	<div class="col-sm-6 form-group">
			                                ...
			                                <form:input type = "text" class="required form-control" id="qamStartDate" name = "qamStartDate" path="qamStartDate" />
			                                <form:input type = "hidden" name = "id" path="id" />
			                            </div>
			                            <div class="col-sm-6 form-group">
			                                <label for="name"> End Date:</label>
			                                <form:input type = "text" class="form-control" id="qamEndDate" name = "qamEndDate" path="qamEndDate"/>
			                            </div>
			                        </div>
				                </div>
				            </div> 
